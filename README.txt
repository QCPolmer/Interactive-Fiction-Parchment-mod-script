Basically, open-web-console and paste this script 
into a running 'parchment' game (tested on https://ifdb.org )

It's jankey, but adds stuff like 
--text to speech (press TAB if nothing typed)
--Autocomplete (press TAB if something typed)
